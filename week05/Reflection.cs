...
namespace Mindfulness
{
    ...
    class Reflection //: Activity
    {
        ...
        protected RandomPrompt()
        {
            Console.WriteLine("How many seconds do you want to spend?");
            string Wish3 = Console.ReadLine();
            int wish3 = Convert.ToInt32(Wish3);
            if (wish3 == 2)
            Console.WriteLine("Welcome to the random  reflection activity.\nThe activity will land you onto randomly chosen options");
                string Interval3 = Console.ReadLine();
                int interval3 = Convert.ToInt32(Interva3);
                for(int e = interval3; e > 0; e--)
                {
